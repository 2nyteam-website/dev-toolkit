...
const tools = [
  ...
  },
  {
    ...
    icon: "Aa",
    tags: ["Lorem", "Text", "Generate"],
  },
  {
    name: "CSS Minifier",
    description: "Minify and beautify CSS code to reduce file size.",
  ...
  },
  {
    ...
    icon: "755",
    tags: ["Chmod", "Unix", "Permission"],
  },
  {
    name: "JSON Path Finder",
    description: "Navigate JSON trees and find JSONPath expressions.",
  ...
  {
    name: "YAML Validator",
    description: "Validate YAML syntax and convert to JSON format.",
    href: "/tools/yaml-validator",
    icon: "YML",
    tags: ["YAML", "Validate", "JSON"],
  },
  {
    name: "SVG Optimizer",
  ...
  },
  {
    ...
    description: "Preview how your links appear on Facebook, Twitter, LinkedIn.",
    href: "/tools/og-preview",
    icon: "OG",
    tags: ["OG", "Preview", "Social"],
  },
];
